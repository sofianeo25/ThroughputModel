...
################################################################################
## Form generated from reading UI file 'wifi avec toggle button.ui'
##
...
from PySide6.QtWidgets import (QCheckBox, QComboBox, QDial,
                               QFrame, QGridLayout, QGroupBox, QHBoxLayout,
                               QLabel, QLayout, QLineEdit, QPushButton, QRadioButton, QSizePolicy, QSpacerItem,
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.vertical_trois.addLayout(self.other_parameters_802_11_n_2)


        self.gridLayout_4.addLayout(self.vertical_trois, 2, 2, 1, 1)

        self.vertical_quatre = QVBoxLayout()
        self.vertical_quatre.setObjectName(u"vertical_quatre")
        ...
        self.checkBox_dcm = QCheckBox(self.groupbox_dcm)
        ...
        sizePolicy5.setHeightForWidth(self.checkBox_dcm.sizePolicy().hasHeightForWidth())
        self.checkBox_dcm.setSizePolicy(sizePolicy5)
        self.checkBox_dcm.setStyleSheet(u"QCheckBox::indicator {\n"
"	width: 40px;\n"
"	height: 40px;\n"
"\n"
"}\n"
...
"	image: url(:/toggle/toggle_on_icon.png);\n"
"\n"
"}\n"
"\n"
"QCheckBox::indicator:unchecked{\n"
"	image: url(:/toggle/toggle_off_icon.png);\n"
"\n"
"}")
        self.checkBox_dcm.setCheckable(True)

        self.DCM.addWidget(self.checkBox_dcm)


        self.vertical_quatre.addWidget(self.groupbox_dcm)
        ...
        self.vertical_quatre.addWidget(self.groupbox_nru)
        ...
        self.vertical_quatre.addWidget(self.groupbox_mu_mimo)
        ...
        self.vertical_quatre.addWidget(self.groupbox_ofdma)
        ...
        self.vertical_quatre.addWidget(self.groupbox_angle_quantif)


        self.gridLayout_4.addLayout(self.vertical_quatre, 2, 4, 1, 1)
        ...
        self.vertical_deux.addWidget(self.groupbox_modulation)
        ...
        self.vertical_deux.addWidget(self.groupBox_sgi_btn)

        self.verticalSpacer_2 = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.vertical_deux.addItem(self.verticalSpacer_2)
        ...
        self.vertical_deux.addWidget(self.groupbox_sgi_dl_ul)
        ...
        self.vertical_deux.addWidget(self.groupbox_wifi_n)
        ...
        self.vertical_deux.addWidget(self.groupbox_antennas)


        self.gridLayout_4.addLayout(self.vertical_deux, 2, 0, 1, 1)
        ...
        self.vertical_un = QGroupBox(self.frame_left)
        ...
        sizePolicy7.setHeightForWidth(self.vertical_un.sizePolicy().hasHeightForWidth())
        self.vertical_un.setSizePolicy(sizePolicy7)
        self.vertical_un.setMinimumSize(QSize(1220, 85))
        self.horizontalLayout_6 = QHBoxLayout(self.vertical_un)
        ...
        self.bandwidth_label = QLabel(self.vertical_un)
        ...
        self.comboBox_bandwidth = QComboBox(self.vertical_un)
        ...
        self.label = QLabel(self.vertical_un)
        self.label.setObjectName(u"label")
        self.label.setAlignment(Qt.AlignCenter)

        self.frequency_band.addWidget(self.label)

        self.comboBox_frequency_band = QComboBox(self.vertical_un)
        ...
        self.standard_selection_label = QLabel(self.vertical_un)
        ...
        self.comboBox_standard_selection = QComboBox(self.vertical_un)
        ...
        self.gridLayout_4.addWidget(self.vertical_un, 1, 0, 1, 5)
